...
> Icon legend
> <i class="fas fa-database"></i> Data are openly accessible (click on the OSF icon to acces the repository)
> <i class="fas fa-file-tex"></i> The author post-print version is accessible for papers not in open access (click the icon to start the download).
> <i class="fas fa-cog"></i> The material is openly accessible (click the OSF icon to access the repository).
> <i class="fas fa-file-code"></i> The statistical output files and/or the code for processing the data are openly accessible (click the OSF icon to access the repository).
