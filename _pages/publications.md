...
> **Icon legend**
>
> <i class="fas fa-database"></i> Data openly accessible (click the <i class="ai ai-osf"></i> icon to acces the repository)
>
> <i class="fas fa-file-alt"></i> Author post-print version openly accessible for papers not in open access (click the icon to start the download).
>
> <i class="fas fa-cog"></i> Material openly accessible (click the <i class="ai ai-osf"></i> icon to access the repository).
>
